...
public class detailProduk_pengadaanDAO {
    private String id_produk_tambah, nama_produk, satuan_produk;
    private Integer jumlah_produk;

    public detailProduk_pengadaanDAO(String id_produk_tambah, String nama_produk, String satuan_produk, Integer jumlah_produk) {

...
public class detail_penjualan_produkDAO {
    private String id_detail_trans_produk, id_produk, nama_produk, nama_jenis_hewan, satuan_produk, status_data, time_stamp, keterangan;
    private Integer harga_satuan_produk, jumlah_produk, jumlah_harga_produk;

    public detail_penjualan_produkDAO(String id_detail_trans_produk, String id_produk, String nama_produk, String nama_jenis_hewan, String satuan_produk, String status_data, String time_stamp, String keterangan, Integer harga_satuan_produk, Integer jumlah_produk, Integer jumlah_harga_produk) {

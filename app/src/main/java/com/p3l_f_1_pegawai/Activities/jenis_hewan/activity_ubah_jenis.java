...
public class activity_ubah_jenis extends AppCompatActivity {
    private String URLline = "http://192.168.0.200/CI_Mobile_P3L_1F/index.php/jenishewan/";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubah_jenis);
        setAtribut();
        ...
        simpan_jenis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ubahJenis(nama_jenis, nama_pengguna);
        ...
        batal_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(activity_ubah_jenis.this, "Batal Ubah Jenis!", Toast.LENGTH_LONG).show();
    ...
    private void ubahJenis(final String string_nama, final String nama_pengguna){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(activity_ubah_jenis.this, "Koneksi Terputus",

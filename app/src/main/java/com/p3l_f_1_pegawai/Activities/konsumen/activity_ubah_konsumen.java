...
public class activity_ubah_konsumen extends AppCompatActivity {
    private String URLline = "http://192.168.8.103/CI_Mobile_P3L_1F/index.php/konsumen/";
    ...
    private String id_konsumen, status_konsumen, nama_user;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ubah_konsumen);
        setAtribut();
        ...
        batal_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(activity_ubah_konsumen.this, "Batal Ubah Konsumen!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void setAtribut(){
        ...
        tgl_lahir.setText(getIntent().getStringExtra("tgl_lahir_konsumen"));
        telepon_konsumen = (TextInputEditText) findViewById(R.id.telepon_konsumen);
        telepon_konsumen.setText(getIntent().getStringExtra("no_tlp_konsumen"));

        id_konsumen = getIntent().getStringExtra("id_konsumen");
        status_konsumen = getIntent().getStringExtra("status_member");

        simpan_konsumen = (Button) findViewById(R.id.edit_konsumen);
        ...
        if(status_konsumen.equalsIgnoreCase("guest")){
            mRadioGroup.check(R.id.guest);
        }
        else{
            mRadioGroup.check(R.id.member);
        }
        int selectedId = mRadioGroup.getCheckedRadioButtonId();
        status_member = findViewById(selectedId);
    }
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(message.equalsIgnoreCase("Berhasil")) {
                    ...
                    tgl_lahir.getText().clear();
                    telepon_konsumen.getText().clear();
                    Toast.makeText(activity_ubah_konsumen.this, "Data Konsumen Berhasil Diubah!", Toast.LENGTH_LONG).show();
                }
                else if(message.equalsIgnoreCase("Gagal")) {
                    Toast.makeText(activity_ubah_konsumen.this, "Kesalahan Koneksi", Toast.LENGTH_LONG).show();
                }
                dialog.dismiss();
            }
        }, 2000);
    ...
    private void tambahKonsumen(final String nama, final String alamat, final String tgl_lahir, final String telepon, final String nama_pengguna, final String status_member){
        final String url = URLline + id_konsumen;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(activity_ubah_konsumen.this, "Koneksi Terputus",

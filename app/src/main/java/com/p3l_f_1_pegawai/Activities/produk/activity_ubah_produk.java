...
public class activity_ubah_produk extends AppCompatActivity {
    private String URLline = "http://192.168.0.200/CI_Mobile_P3L_1F/index.php/produk/";
    ...
    private Button ubah_foto, ubah_produk, batal_ubah;
    ...
    private void setAtribut(){
        nama_produk = (TextInputEditText) findViewById(R.id.nama_produk_ubah);
        nama_produk.setText(getIntent().getStringExtra("nama_produk"));
        harga_produk = (TextInputEditText) findViewById(R.id.harga_produk_ubah);
        harga_produk.setText(getIntent().getStringExtra("harga_produk"));
        satuan_produk = (TextInputEditText) findViewById(R.id.satuan_produk_ubah);
        satuan_produk.setText(getIntent().getStringExtra("satuan_produk"));
        stok_produk = (TextInputEditText) findViewById(R.id.stok_produk_ubah);
        stok_produk.setText(getIntent().getStringExtra("stok_produk"));
        stok_minimal_produk = (TextInputEditText) findViewById(R.id.stok_minimal_produk_ubah);
        stok_minimal_produk.setText(getIntent().getStringExtra("stok_minimal_produk"));
        foto_produk = (ImageView) findViewById(R.id.foto_produk_ubah);
        Glide.with(getApplicationContext()).load(getIntent().getStringExtra("foto_produk")).into(foto_produk);
        ubah_produk = (Button) findViewById(R.id.button_simpan);
        batal_ubah = (Button) findViewById(R.id.button_batal);
        ubah_foto = (Button) findViewById(R.id.button_ubah_foto);
    ...
    public void setSpinner_jenis(){
        String url = "http://192.168.0.200/CI_Mobile_P3L_1F/index.php/jenishewan";

...
public class ProdukFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        tambahProduk = view.findViewById(R.id.fab_produk);
        tambahProduk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), activity_tambah_produk.class);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                produk r = new produk(objectReview.getString("id_produk"),

...
public class activity_ubah_hewan extends AppCompatActivity {
    private String URLline = "http://192.168.0.200/CI_Mobile_P3L_1F/index.php/hewan/";
    ...
    private String id_jenis_hewan, id_ukuran_hewan, id_konsumen, id_hewan, nama_user, nama_jenis_hewan, nama_ukuran_hewan, nama_konsumen;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubah_hewan);
        setAtribut();
        ...
        batal_simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(activity_ubah_hewan.this, "Batal Ubah Hewan!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void setAtribut(){
        ...
        simpan_hewan = (Button) findViewById(R.id.edit_hewan);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(message.equalsIgnoreCase("Berhasil")) {
                    nama_hewan.getText().clear();
                    tgl_lahir_hewan.getText().clear();
                    Toast.makeText(activity_ubah_hewan.this, "Data Hewan Berhasil Diubah!", Toast.LENGTH_LONG).show();
                }
                else if(message.equalsIgnoreCase("Gagal")) {
                    Toast.makeText(activity_ubah_hewan.this, "Kesalahan Koneksi", Toast.LENGTH_LONG).show();
                }
                dialog.dismiss();
            }
        }, 2000);
    ...
    private void tambahHewan(final String string_nama, final String tgl_lahir, final String id_jenis_hewan, final String id_ukuran_hewan, final String nama_pengguna, final String id_konsumen){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(activity_ubah_hewan.this, "Koneksi Terputus",
